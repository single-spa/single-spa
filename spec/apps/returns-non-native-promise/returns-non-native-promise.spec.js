...
describe(`returns-non-native-promise`, () => {
  ...
  beforeAll(() => {
    singleSpa.registerApplication('./returns-non-native-promise.app.js', () => import('./returns-non-native-promise.app.js'), location => location.hash === "#returns-non-native-promise");
    singleSpa.start();
  });
