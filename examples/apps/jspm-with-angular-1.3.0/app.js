...
const jspmApp = defaultJspmApp({
	configJsURI: '/apps/jspm-with-angular-1.3.0/config.js',
	systemJsURI: '/apps/jspm-with-angular-1.3.0/jspm_packages/system.src.js'
})
...
export const entryURI = '/apps/jspm-with-angular-1.3.0/entry.js';
